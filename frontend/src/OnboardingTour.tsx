...
export const ONBOARDING_TIPS: TipStep[] = [
  ...
  },
  {
    ...
    body: "Цель не возникает из воздуха — она вырастает из положения дел. Начать можно с вопроса «Что вы хотите изменить?» или с фиксации проблемы: мастер цели спросит об основании, а историю формулировки можно проследить до исходных фактов.",
    highlight: "problems",
    articleUrl: "https://thinkred.ru/blog/dialectical-goal-tree.html",
    articleTitle: "Диалектическое дерево целей",
  },
  ...
  {
    id: "membership",
    title: "Участие вместо членства",
    body: "1. Контекстность — в одной цели вы участник, в другой эксперт. 2. Добровольность — вклад берётся обязательством, а не назначается. 3. Доказуемость — компетенции подтверждаются выполненной работой, а не словами.",
    articleUrl: "https://thinkred.ru/blog/digital-twin-membership.html",
    articleTitle: "Цифровой двойник и членство",
  },
  {
