...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (path === "/auth/callback") {
      ...
      request<User>("/auth/me").then(setUser).then(loadProblems).catch(() => {
  ...
  const submitAuth = async (event: FormEvent) => {
    ...
    try {
      ...
      setUser(data.user); await loadProblems();
    } catch (e) {
