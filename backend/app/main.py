...
from .routers import ai, auth, commitments, competences, dashboard, entities, google, goal_graph, goal_lifecycle, goal_participation, knowledge, notifications, profile, search, stepik
